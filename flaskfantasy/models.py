...
class Projections(db.Model):
    ...
    field_goal = db.Column(db.Float(2), nullable=False)
    field_goal_att = db.Column(db.Float(2), nullable=False)
    extra_pt = db.Column(db.Float(2), nullable=False)
    sack = db.Column(db.Float(2), nullable=False)
    interception = db.Column(db.Float(2), nullable=False)
    fumble_recovered = db.Column(db.Float(2), nullable=False)
    forced_fumble = db.Column(db.Float(2), nullable=False)
    def_td = db.Column(db.Float(2), nullable=False)
    safety = db.Column(db.Float(2), nullable=False)
    pts_allowed = db.Column(db.Float(2), nullable=False)
    yd_against = db.Column(db.Float(2), nullable=False)
    season = db.Column(db.SmallInteger, nullable=False)
    source_name = db.Column(db.String(25), nullable=False) 
    source_update = db.Column(db.Date, nullable=False, default=datetime.utcnow)
    insert_timestamp = db.Column(db.DateTime, nullable=False) 
